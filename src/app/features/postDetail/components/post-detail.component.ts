...
@Component({
  ...
  styleUrls: ['./post-detail.component.scss','../../shared/styles/shared.styles.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PostDetailComponent implements OnInit {

  constructor(private postService: PostService,private cdr: ChangeDetectorRef, public loginService: LoginService) { }
  ...
  loadData() {
    this.postService.getPost(this.postService.postId).pipe(
      tap(response => {
  ...
  addComment() {
    ...
    this.postService.getPost(this.postService.postId).subscribe(data => {
      ...
      this.postService.updateData(this.postService.postId, post).subscribe(d => {
        this.loadData();
      });
    })
  }
