...
export class UserpageComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.postService
      .getUserPosts(this.loginService.loggedId)
      .pipe(tap((response) => this.posts.next(response)))
      .subscribe();
  }
  ...
  updatePost(): void {
    ...
    this.postService
      .updateData(this.postId, formValue as unknown as Post)
      .subscribe((data) => {
        this.postService
          .getUserPosts(this.loginService.loggedId)
          .pipe(tap((response) => this.posts.next(response)))
